        ...
        <Row className={'justify-content-center no-margin-row'}>
          ...
          <div className={'terms-container'}>
            <div className='terms'>
              ...
              <p>If you agree to participate, we would like you to answer 53 multiple-choice questions about a series of data visualization. For each question, you will see a data visualization and a problem to solve. Choose the BEST answer to the questions. If you are unsure, Select ''Skip'' instead of guessing. You are also free to skip any questions that you prefer not to answer. In the end, you will complete a brief demographic survey and then see your final score.</p>
              ...
              <p>You will be paid for being in this research study. You will receive a pay of $6 for completing this quiz. At the end of the study, copy your survey code back to Prolific to receive your payment.</p>
